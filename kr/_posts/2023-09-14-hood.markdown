...
![Alt text](/assets/img/posts/hood/message_edge.png){: width="70%""}{:data-align="center"}

그 다음, $v_{i}$는 인접한 edge feature들의 평균을 통해서 업데이트 됩니다.

![Alt text](/assets/img/posts/hood/message_edge.png){: width="80%""}{:data-align="center"}

이 때, $f_{v\rightarrow e}$, $f_{e\rightarrow v}$는 모두 MLP로 구성된 network입니다.
